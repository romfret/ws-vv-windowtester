...
public class AddressListPanel extends javax.swing.JPanel {
	...
	public void addListenersToAddressList() {
		this.addListSelectionListener(new ListSelectionListener() {
			
			@Override
			public void valueChanged(ListSelectionEvent arg0) {
				if (arg0.getFirstIndex() != -1) {
					aap.setDeleteButtonEnabled(true);
					aap.setEditButtonEnabled(true);
				}
				else {
					aap.setDeleteButtonEnabled(false);
					aap.setEditButtonEnabled(false);
				}
