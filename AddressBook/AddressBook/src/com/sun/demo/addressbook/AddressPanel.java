...
public class AddressPanel extends javax.swing.JPanel {
	...
	public void setEditable(boolean bEditable) {
		...
		//ajout par nous
		aap.setCancelButtonEnabled(bEditable);

	}
	
	// *****************************
	//Fonctions rajout�es par nous
	private AddressActionPanel aap;
	public void setAddressActionPanel(AddressActionPanel aap) {
		this.aap = aap;
	}
	public void addListenersToTextFields() {
		...
		txtLastName.addKeyListener(new KeyListener() {
			...
			@Override
			public void keyReleased(KeyEvent e) {
				if (!txtLastName.getText().trim().isEmpty() && !txtLastName.getText().trim().isEmpty())
					aap.setSaveButtonEnabled(true);
			}
